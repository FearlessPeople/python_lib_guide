...
class DateUtil:
    @staticmethod
    def time_stamp_by_dt(dtstr):
        """
        获取指定%Y-%m-%d %H:%M:%S格式日期的时间戳形式
        :return:
        """
        datetime_object = datetime.strptime(dtstr, '%Y-%m-%d %H:%M:%S')
    ...
    @staticmethod
    def minutes_before_now(minutes):
        """
        获取几分钟前时间
        :param minutes:
        :return:
        ...
        # 计算几分钟前的时间
        minutes_before = current_time - timedelta(minutes=minutes)
    ...
    @staticmethod
    def this_month_first_day(any_time=datetime.now()):
        """
        本月1号
        :param any_time:
        :return:
    ...
    @staticmethod
    def up_month_the_same_day(any_time=datetime.now()):
        """
        上个月同一天
        :param any_time:
        :return:
    ...
    @staticmethod
    def up_month_first_day(any_time=datetime.now(), fmt=TimeFmt.YYYY_mm_dd):
        """
        上个月1号
        :param fmt:
        :param any_time:
        ...
        """
        last_month = any_time.replace(day=1) - timedelta(days=1)
        last_month_date = last_month.replace(day=1)
        return last_month_date.strftime(fmt)

    # @staticmethod
    # def up_month_first_day(fmt=TimeFmt.YYYY_mm_dd):
    #     """
    #     上月第一天
    #     :return:
    #     """
    ...
    #     return first_day_of_last_month.strftime(fmt)
    ...
    @staticmethod
    def up_month_last_day(any_time=datetime.now(), fmt=TimeFmt.YYYY_mm_dd):
        """
        上个月最后一天
        :param fmt:
        :param any_time:
        :return:
        """
        up_last_day_date = any_time.replace(day=1) - timedelta(days=1)
        return up_last_day_date.strftime(fmt)
...
if __name__ == '__main__':
    minute = 0
    print(DateUtil.fmt(DateUtil.minutes_before_now(5),TimeFmt.YYYY_mm_dd_HH_MM_SS))
